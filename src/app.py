...
#     else:
#         return jsonify('This mail does not exist')
#
#
# # Retrieve planet
...
#     if test:
#         return jsonify(message='There is already by that name!'), 409
#     else:
...
#         db.session.commit()
#         return jsonify(message='You have update a planet'), 202
#     else:
#         return jsonify(message='Planet does not exist!'), 404
#
#
